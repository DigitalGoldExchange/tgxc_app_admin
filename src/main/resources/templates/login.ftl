...
<#--            </div>-->
        ...
        <div class="login-wrap-logo d-flex flex-column justify-content-center align-items-center">
            <form id="loginForm">
                ...
                <#--						</div>-->
                <button type="button" class="btn btn-primary login-text btn-block mt-5" onclick="login();">로그인</button>
                <a href="/find" class="btn btn-signUp signUp-text btn-block btn-h4" >비밀번호 찾기</a>
            </form>
        </div>
    </div>
</div>
